    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li>
		  ...
		  <li>
          <a  href="sales.php?id=tr<?php echo date("ymdhis");?>">
            <i class="fa fa-file-text-o"></i> <span>Product Transfer</span>
            <span class="pull-right-container">
...
<li><a href="transfer.php"><i class="fa fa-circle-o text-yellow"></i> Product Transfer Report</a>
          </ul>
        </li>
		  <?php } ?>
          </ul>
